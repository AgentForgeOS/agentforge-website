...
**Lead:** AgentForgeOS is early, and deliberately so — we work closely with a small number of design partners while the decision layer proves itself in real operations. Tell us about your operation, and if there's a fit, you'll hear from a person.
...
- What would you like to explore? (optional, textarea) — the decision or operation you're weighing AgentForgeOS for
